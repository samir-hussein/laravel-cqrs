...
abstract class Query
{
    ...
    /**
     * Get a specific value from query data.
     *
     * @param string $key
     * @param mixed $default
     * @return mixed
    ...
    /**
     * Check if a key exists in query data.
     *
     * @param string $key
     * @return bool
     */
    ...
    /**
     * Get validation rules for the query.
     * Override this method in your query class to provide validation rules.
     *
     * @return array
     */
     ...
     * Override this method in your query class to provide custom messages.
     *
     * @return array
     */
     ...
     * Override this method in your query class to provide custom attribute names.
     *
     * @return array
     */
    ...
    /**
     * Validate the query data using Laravel's validator.
    ...
    /**
     * Check if the query data is valid without throwing an exception.
     *
     * @return bool
     */
